...
description: Add and review Dynamic Type support in UIKit and SwiftUI. Use for scalable fonts, adaptive layouts, Large Content Viewer, bold text, and accessibility content sizes.
---
